...
int main(int argc, char *argv[])
{
    ...
    if (argc == 2)
    {
        if (!strcmp(argv[1], "bench"))
        {
            ...
            auto bench_start_time = get_time_since_start();
            ...
            auto t = (get_time_since_start() - bench_start_time) / 1000.0; // in seconds

            std::cout << total_nodes << " nodes " << static_cast<int>(total_nodes / t) << " nps\n";
            return 0;
        }

        std::cerr << "Expected bench argument, got <" << argv[1] << ">\n";
        return 0;
    }
