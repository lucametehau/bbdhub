...
namespace BBD {
    ...
    */
    ...
    enum MoveTypes : MoveType {
        ...
        PROMO_KNIGHT = 4, PROMO_BISHOP, PROMO_ROOK, PROMO_QUEEN
    };
    ...
    First 6 bits for the from square, the next 6 bits for the to square and the last 4 for the move type
    */
    ...
    public:
        ...
        operator bool() const { return m_move; }

        constexpr Square from() const { return m_move & 63; }
        constexpr Square to() const { return (m_move >> 6) & 63; }
        constexpr MoveType type() const { return (m_move >> 12) & 7; }
        ...
        std::string to_string() {
            ...
            if (is_promo()) move_str += promotion_piece().to_char();
            return move_str;
        }
    };
