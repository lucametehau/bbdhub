 ...
 public:
    ...
    constexpr Board() {
        ...
        for ( Square sq = 0; sq < 64; sq++ ) {
            if ( squares[sq] && squares[sq].color() == Colors::WHITE ) {
    ...
    bool make_move(const Move& move) {
        ...
        switch ( move.type()) {
            ...
            case PROMO_QUEEN:
                ...
                squares[from] =
                    (current_color ? Piece(2 * move.promotion_piece() + 1) : Piece(2 * move.promotion_piece()));
    ...
    bool undo_move(const Move& move) {
        ...
        switch ( move.type()) {
            ...
            case PROMO_BISHOP:
            case PROMO_ROOK:
            case PROMO_QUEEN:pieces[current_color][squares[to].type()].set_bit(to, true);
