...
TEST(BoardTest, testing)
{
    try
    {
        auto *board = new Board();
        std::cerr << "created an object board \n";
        board->~Board();
        std::cerr << "deleted an object board \n";
    }
    catch (...)
    {
        std::cerr << "error!\n";
...
TEST(BoardTest5, WhiteEnPassant)
{
    auto *board = new Board();
...
TEST(BoardTest6, BlackEnPassant)
{
    auto *board = new Board();
